    ...
    <>
      <main className="w-1/2 mx-auto">
        ...
        <form className="drop-shadow bg-pandaWhite text-pandaBlack flex flex-col p-6 w-70 rounded-md">
          ...
          <input className="border border-gray-200  rounded-md h-8 px-2" type="text" id="name" name="name" />
          <label className="mt-4 font-bold" htmlFor="email">EMAIL:</label>
          <input className="border border-gray-200 rounded-md h-8 px-2 " type="email" id="email" name="email" />
          <label className="mt-4 font-bold " htmlFor="message">MESSAGE:</label>
          <textarea className="border border-gray-200 rounded-md" id="message" name="message"></textarea>
